...
function BuildFunction(data){
    ...
    for (spec in data.specs) {
        specText += data.specs[spec] + ", "
    }
    specText = specText.slice(0, -2)
    specc.innerHTML = specText
    ...
    let kuka = document.createElement("td")

    // kuka SVG
    let iconSvgk = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    let iconPathk = document.createElementNS(
      'http://www.w3.org/2000/svg',
      'path'
    )

    iconSvgk.setAttribute('xmlns', 'http://www.w3.org/2000/svg')
    iconSvgk.setAttribute('width', '24');
    iconSvgk.setAttribute('height', '24')
    iconSvgk.setAttribute('fill', 'currentColor');
    iconSvgk.setAttribute('viewBox', '0 0 448 512');
    ...
    iconSvgk.appendChild(iconPathk)
    kuka.appendChild(iconSvgk)
    ...
    if(data.name == localStorage.getItem("memory")){
        ...
        kuka.addEventListener("click", ()=>{
            ...
            localStorage.removeItem("memoryAr")
            location.reload()
        })
    }
    if(data.name == localStorage.getItem("monitor")){
        Row.classList.add("monitor-row")
        
        iconSvgl.classList.add('bi');
        iconSvgl.classList.add('bi-display');
    ...
    if(data.name == localStorage.getItem("bill")){
        Row.classList.add("bill-row")
        
        iconSvgl.classList.add('bi');
        iconSvgl.classList.add('bi-keyboard');
    ...
    if(data.name == localStorage.getItem("eger")){
        Row.classList.add("eger-row")
        
        iconSvgl.classList.add('bi');
        iconSvgl.classList.add('bi-mouse');
